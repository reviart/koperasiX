        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('penerimaan.edit.submit', [$datas[0]->id]) }}">
                      {{ csrf_field() }}
                      {{ method_field('PUT') }}
                        <?php
                        ...
                        <div class="form-group{{ $errors->has('nilai') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="nilai" type="number" class="form-control" name="nilai" value="{{$datas[0]->nilai}}" required>
                                @if ($errors->has('nilai'))

        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('kontrak.store.submit') }}">
                        {{ csrf_field() }}
                        <?php
                        ...
                        <div class="form-group{{ $errors->has('nomor_kontrak') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="nomor_kontrak" type="text" class="form-control" name="nomor_kontrak" autocomplete="off" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('nama_pekerjaan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="nama_pekerjaan" type="text" class="form-control" name="nama_pekerjaan" autocomplete="off" required>
                        ...
                        <div class="form-group{{ $errors->has('nama_pelaksana') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="nama_pelaksana" type="text" class="form-control" name="nama_pelaksana" autocomplete="off" required>
                        ...
                        <div class="form-group{{ $errors->has('nilai_kerja') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="nilai_kerja" type="number" class="form-control" name="nilai_kerja" placeholder="Contoh: 25000" required>
                        ...
                        <div class="form-group{{ $errors->has('tahap_bayar') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-8">
                                <input id="tahap_bayar" type="number" class="form-control" name="tahap_bayar" placeholder="Contoh: 2">
                        ...
                        <div class="form-group{{ $errors->has('tgl_kontrak') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                              <input type='date' class="form-control" class="form-control" name="tgl_kontrak" required/>
                        ...
                        <div class="form-group{{ $errors->has('tgl_mulai') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                              <input type='date' class="form-control" class="form-control" name="tgl_mulai" required/>
                        ...
                        <div class="form-group{{ $errors->has('tgl_selesai') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-4">
                              <input type='date' class="form-control" class="form-control" name="tgl_selesai" required/>
